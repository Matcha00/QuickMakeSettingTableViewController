...
@class MatchaCellModel;
/// 设置RGB颜色和透明度
#define MatchaColorWithRGB(R,G,B,A) [UIColor colorWithRed:R/255.0 green:G/255.0 blue:B/255.0 alpha:A]
///屏幕宽度
#define MatchaScreenWidth [UIScreen mainScreen].bounds.size.width
///屏幕长度
#define MatchaScreenHeight [UIScreen mainScreen].bounds.size.height
///屏幕范围
...
@interface MatchaSettingTableViewCell : UITableViewCell

@property (nonatomic, strong) MatchaCellModel *model;
